...
let main argv =
    ...
    Console.WriteLine("Максимум:{0}", max_up x)
    Console.WriteLine("Минимум:{0}", min_up x)
    Console.WriteLine("Произведение:{0}", pr_down x 1)
    Console.WriteLine("Максимум:{0}", max_down x 0)
    Console.WriteLine("Минимум:{0}", min_down x 9)
    0 